...
import { FaCamera, FaFile, FaImage, FaVideo } from 'react-icons/fa'
...
export default function FormikFileUpload(props : IProps) {
    ...
    const onChange = (e : any) => {
        const fileTypes = props.AvalibleFormat;
            ...
            >

                {
                    ...
                    <>
                            ...
                            <>
                                <FaFile size={60} className="mb-2" color={theme.colors.textSecondary}
                                ></FaFile>
                                <br></br>
                                Añádir archivo
                            </>
                    ...
                    <Thumb isVideo={false} file={formik.values[name]}></Thumb>
                }
            </label>
